...
export const MonumentEnum = {
    ...
    HARBOR: 'HARBOR',
    LARGE_HARBOR: 'LARGE_HARBOR',
    SMALL_HARBOR: 'SMALL_HARBOR',
    ICE_LAKE: 'ICE_LAKE',
    JUNKYARD: 'JUNKYARD',
...
export const monumentEnumAliasMap = new globalThis.Map([
    ...
    ['large harbor', MonumentEnum.LARGE_HARBOR],
    ['large harbour', MonumentEnum.HARBOR],
    ['small harbor', MonumentEnum.SMALL_HARBOR],
    ['small harbour', MonumentEnum.SMALL_HARBOR],
    ...
    ['scientist compound', MonumentEnum.SCIENTIST_COMPOUND],
